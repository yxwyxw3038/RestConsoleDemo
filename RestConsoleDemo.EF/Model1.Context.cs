...
namespace RestConsoleDemo.EF
{
    ...
    public partial class AchieveDBEntities : DbContext
    {
        ...
        public virtual DbSet<tbBillNo> tbBillNo { get; set; }
        ...
        public virtual DbSet<tbNoticeUser> tbNoticeUser { get; set; }
        public virtual DbSet<tbParameter> tbParameter { get; set; }
